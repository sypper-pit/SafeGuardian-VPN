...
execute_setup "ovpn-over-tor" "10.0.4.170"
execute_setup "ovpn-p-over-tor" "10.0.4.180"
...
execute_script "tor-over-vpn.sh" "10.0.4.20"
execute_script "desktop.sh" "10.0.4.2"
execute_script "ssh-vpn-server.sh" "10.0.4.15"
